...
/**
 * @extends Factory<\App\Models\IntrastatLine>
 */
final class IntrastatLineFactory extends Factory
{
    private const array EU_PARTNER_COUNTRIES = [
        CountryCode::DE,
        CountryCode::AT,
        CountryCode::FR,
        CountryCode::IT,
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'cn_code_id' => CnCode::factory(),
            'cn_code' => fake()->numerify('########'),
            'quantity' => $quantity,
            ...
            'country_of_origin' => fake()->randomElement([...self::EU_PARTNER_COUNTRIES, CountryCode::PL, CountryCode::CZ, CountryCode::SK]),
    ...
    public function forArrival(): static
    {
        return $this->state(fn (array $attributes): array => [
            'country_of_consignment' => fake()->randomElement(self::EU_PARTNER_COUNTRIES),
    ...
    {
        return $this->state(fn (array $attributes): array => [
            'country_of_consignment' => CountryCode::HU,
            'country_of_destination' => fake()->randomElement(self::EU_PARTNER_COUNTRIES),
            'country_of_origin' => CountryCode::HU,
        ]);
    }
