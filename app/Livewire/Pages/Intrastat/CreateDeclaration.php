...
final class CreateDeclaration extends Component implements HasActions, HasSchemas
{
    use HasCreateForm;
    ...
    {
        return view('livewire.pages.intrastat.create-declaration');
    }
    ...
    {
        return 'dashboard.intrastat-declarations';
    }
