...
final class ViewCategory extends Component implements HasActions, HasSchemas
{
    use HasViewInfolist;
    ...
    {
        return view('livewire.pages.categories.view-category');
    }
